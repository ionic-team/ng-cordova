...
plugin-name: $cordovaFacebook
source:  https://github.com/driftyco/ng-cordova/blob/master/src/plugins/facebook.js
official-docs:  https://github.com/Wizcorp/phonegap-facebook-plugin
icon-apple: true
icon-android: true
icon-windows: false
---
