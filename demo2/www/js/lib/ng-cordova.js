...
System.register('ng-cordova/deviceOrientation', [], function (_export) {
  ...
  return {
    ...
    execute: function () {
      angular.module('ngCordova.plugins.deviceOrientation', []).factory('$cordovaDeviceOrientation', ['$q', function ($q) {
        ...
        return {
          getCurrentHeading: function getCurrentHeading() {
            var q = $q.defer();
          ...
          watchHeading: function watchHeading(options) {
            var q = $q.defer();
...
System.register('ng-cordova/file', [], function (_export) {
...
System.register('ng-cordova/fileTransfer', [], function (_export) {
  ...
  return {
    ...
    execute: function () {
      angular.module('ngCordova.plugins.fileTransfer', []).factory('$cordovaFileTransfer', ['$q', '$timeout', function ($q, $timeout) {
        return {
          download: function download(source, filePath, options, trustAllHosts) {
            var q = $q.defer();
          ...
          upload: function upload(server, filePath, options, trustAllHosts) {
            var q = $q.defer();
            var ft = new FileTransfer();
...
System.register('ng-cordova/ga', [], function (_export) {
    ...
    execute: function () {
      angular.module('ngCordova.plugins.ga', []).factory('$cordovaGA', ['$q', '$window', function ($q, $window) {
        ...
        return {
          ...
          exit: function exit(success, fail) {
            var q = $q.defer();
...
System.register('ng-cordova/httpd', [], function (_export) {
...
System.register('ng-cordova/inappbrowser', [], function (_export) {
...
System.register('ng-cordova/media', [], function (_export) {
  ...
  return {
    ...
    execute: function () {
      angular.module('ngCordova.plugins.media', []).factory('$cordovaMedia', ['$q', function ($q) {
        ...
        return {
          newMedia: function newMedia(src) {
            var q = $q.defer();
...
System.register('ng-cordova/module', [], function (_export) {
  'use strict';
...
System.register('ng-cordova/nativeAudio', [], function (_export) {
  ...
  return {
    ...
    execute: function () {
      angular.module('ngCordova.plugins.nativeAudio', []).factory('$cordovaNativeAudio', ['$q', '$window', function ($q, $window) {
        ...
        return {
          preloadSimple: function preloadSimple(id, assetPath) {
            var q = $q.defer();
          ...
          preloadComplex: function preloadComplex(id, assetPath, volume, voices) {
            var q = $q.defer();
          ...
          play: function play(id, completeCallback) {
            var q = $q.defer();
          ...
          setVolumeForComplexAsset: function setVolumeForComplexAsset(id, volume) {
            var q = $q.defer();
...
System.register("ng-cordova/oauth", [], function (_export) {
    ...
    return {
        setters: [],
        execute: function () {
            angular.module("oauth.providers", ["oauth.utils"]).factory("$cordovaOauth", ["$q", "$http", "$cordovaOauthUtility", function ($q, $http, $cordovaOauthUtility) {
                ...
                return {
                    ...
                    *
                     ...
                     * @return   promise
                     */
                    adfs: function adfs(clientId, adfsServer, relyingPartyId) {
                            ...
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                ...
                                browserRef.addEventListener("loadstart", function (event) {
                                    if (event.url.indexOf("http://localhost/callback") === 0) {
                                        ...
                                        $http({ method: "post", url: adfsServer + "/adfs/oauth2/token", data: "client_id=" + clientId + "&code=" + requestToken + "&redirect_uri=http://localhost/callback&grant_type=authorization_code" }).success(function (data) {
                     ...
                     * @return   promise
                     */
                    dropbox: function dropbox(appKey, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                     ...
                     * @return   promise
                     */
                    digitalOcean: function digitalOcean(clientId, clientSecret, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                ...
                                browserRef.addEventListener("loadstart", function (event) {
                                    if (event.url.indexOf(redirect_uri) === 0) {
                                        var requestToken = event.url.split("code=")[1];
                                        $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
                                        $http({ method: "post", url: "https://cloud.digitalocean.com/v1/oauth/token", data: "client_id=" + clientId + "&client_secret=" + clientSecret + "&redirect_uri=" + redirect_uri + "&grant_type=authorization_code" + "&code=" + requestToken }).success(function (data) {
                                            deferred.resolve(data);
                                        }).error(function (data, status) {
                                            deferred.reject("Problem authenticating");
                                        })["finally"](function () {
                     ...
                     * @return   promise
                     */
                    google: function google(clientId, appScope, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                     ...
                     * @return   promise
                     */
                    github: function github(clientId, clientSecret, appScope, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                ...
                                browserRef.addEventListener("loadstart", function (event) {
                                    if (event.url.indexOf(redirect_uri) === 0) {
                                        ...
                                        $http({ method: "post", url: "https://github.com/login/oauth/access_token", data: "client_id=" + clientId + "&client_secret=" + clientSecret + "&redirect_uri=" + redirect_uri + "&code=" + requestToken }).success(function (data) {
                                            deferred.resolve(data);
                                        }).error(function (data, status) {
                                            deferred.reject("Problem authenticating");
                                        })["finally"](function () {
                     ...
                     * @return   promise
                     */
                    facebook: function facebook(clientId, appScope, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                ...
                                browserRef.addEventListener("loadstart", function (event) {
                                    if (event.url.indexOf(redirect_uri) === 0) {
                                        ...
                                        if (parameterMap.access_token !== undefined && parameterMap.access_token !== null) {
                                            ...
                                            if (event.url.indexOf("error_code=100") !== 0) deferred.reject("Facebook returned error_code=100: Invalid permissions");else deferred.reject("Problem authenticating");
                                        }
                                    }
                                });
                                browserRef.addEventListener("exit", function (event) {
                     ...
                     * @return   promise
                     */
                    linkedin: function linkedin(clientId, clientSecret, appScope, state, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                ...
                                browserRef.addEventListener("loadstart", function (event) {
                                    if (event.url.indexOf(redirect_uri) === 0) {
                                        requestToken = event.url.split("code=")[1];
                                        $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
                                        $http({ method: "post", url: "https://www.linkedin.com/uas/oauth2/accessToken", data: "client_id=" + clientId + "&client_secret=" + clientSecret + "&redirect_uri=" + redirect_uri + "&grant_type=authorization_code" + "&code=" + requestToken }).success(function (data) {
                                            deferred.resolve(data);
                                        }).error(function (data, status) {
                                            deferred.reject("Problem authenticating");
                                        })["finally"](function () {
                     ...
                     * @return   promise
                     */
                    instagram: function instagram(clientId, appScope, options) {
                        var deferred = $q.defer();
                     ...
                     * @return   promise
                     */
                    box: function box(clientId, clientSecret, appState, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                ...
                                browserRef.addEventListener("loadstart", function (event) {
                                    if (event.url.indexOf(redirect_uri) === 0) {
                                        requestToken = event.url.split("code=")[1];
                                        $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
                                        $http({ method: "post", url: "https://app.box.com/api/oauth2/token", data: "client_id=" + clientId + "&client_secret=" + clientSecret + "&redirect_uri=" + redirect_uri + "&grant_type=authorization_code" + "&code=" + requestToken }).success(function (data) {
                                            deferred.resolve(data);
                                        }).error(function (data, status) {
                                            deferred.reject("Problem authenticating");
                                        })["finally"](function () {
                     ...
                     * @return   promise
                     */
                    reddit: function reddit(clientId, clientSecret, appScope, compact, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                ...
                                browserRef.addEventListener("loadstart", function (event) {
                                    if (event.url.indexOf(redirect_uri) === 0) {
                                        ...
                                        $http({ method: "post", url: "https://ssl.reddit.com/api/v1/access_token", data: "redirect_uri=" + redirect_uri + "&grant_type=authorization_code" + "&code=" + requestToken }).success(function (data) {
                                            deferred.resolve(data);
                                        }).error(function (data, status) {
                                            deferred.reject("Problem authenticating");
                                        })["finally"](function () {
                     ...
                     * @return   promise
                     */
                    twitter: function twitter(clientId, clientSecret, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                    ...
                    * @return   promise
                    */
                    meetup: function meetup(clientId, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                     ...
                     * @return   promise
                     */
                    salesforce: function salesforce(loginUrl, clientId) {
                        var redirectUri = "http://localhost/callback";
                        var getAuthorizeUrl = function getAuthorizeUrl(loginUrl, clientId, redirectUri) {
                        ...
                        var startWith = function startWith(string, str) {
                    ...
                    * @return   promise
                    */
                    strava: function strava(clientId, clientSecret, appScope, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                ...
                                browserRef.addEventListener("loadstart", function (event) {
                                    if (event.url.indexOf(redirect_uri) === 0) {
                                        requestToken = event.url.split("code=")[1];
                                        $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
                                        $http({ method: "post", url: "https://www.strava.com/oauth/token", data: "client_id=" + clientId + "&client_secret=" + clientSecret + "&code=" + requestToken }).success(function (data) {
                                            deferred.resolve(data);
                                        }).error(function (data, status) {
                                            deferred.reject("Problem authenticating");
                                        })["finally"](function () {
                     ...
                     * @return   promise
                     */
                    withings: function withings(clientId, clientSecret) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                if (typeof jsSHA !== "undefined") {
                                    ...
                                    $http({ method: "get", url: requestTokenUrlBase + "?" + requestTokenParameters }).success(function (requestTokenResult) {
                                        ...
                                        browserRef.addEventListener("loadstart", function (event) {
                                            if (event.url.indexOf("http://localhost/callback") === 0) {
                                                ...
                                                $http({ method: "get", url: accessTokenUrlBase + "?" + accessTokenParameters }).success(function (result) {
                    ...
                    * @return   promise
                    */
                    foursquare: function foursquare(clientId, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                    ...
                    * @return   promise
                    */
                    magento: function magento(baseUrl, clientId, clientSecret) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                if (typeof jsSHA !== "undefined") {
                                    ...
                                    $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
                                    $http({ method: "post", url: baseUrl + "/oauth/initiate", data: "oauth_callback=http://localhost/callback" }).success(function (requestTokenResult) {
                                        var requestTokenParameters = requestTokenResult.split("&");
                                        var parameterMap = {};
                                        for (var i = 0; i < requestTokenParameters.length; i++) {
                                            parameterMap[requestTokenParameters[i].split("=")[0]] = requestTokenParameters[i].split("=")[1];
                                        ...
                                        browserRef.addEventListener("loadstart", function (event) {
                                            if (event.url.indexOf("http://localhost/callback") === 0) {
                                                ...
                                                $http.defaults.headers.post.Authorization = signatureObj.authorization_header;
                                                $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
                                                $http({ method: "post", url: baseUrl + "/oauth/token" }).success(function (result) {
                                                    var accessTokenParameters = result.split("&");
                                                    var parameterMap = {};
                                                    for (var i = 0; i < accessTokenParameters.length; i++) {
                                                        parameterMap[accessTokenParameters[i].split("=")[0]] = accessTokenParameters[i].split("=")[1];
                     ...
                     * @return   promise
                     */
                    vkontakte: function vkontakte(clientId, appScope) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                    ...
                    /*
                             ...
                             * @return   promise
                             */
                    odnoklassniki: function odnoklassniki(clientId, appScope) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                     ...
                     * @return   promise
                     */
                    imgur: function imgur(clientId, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                     ...
                     * @return   promise
                     */
                    spotify: function spotify(clientId, appScope, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                     ...
                     * @return   promise
                     */
                    uber: function uber(clientId, appScope, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                     ...
                     * @return   promise
                    */
                    windowsLive: function windowsLive(clientId, appScope, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                     ...
                     * @return   promise
                     */
                    yammer: function yammer(clientId, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                     ...
                     * @return   promise
                     */
                    venmo: function venmo(clientId, appScope, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                     ...
                     * @return   promise
                     */
                    stripe: function stripe(clientId, clientSecret, appScope, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                ...
                                browserRef.addEventListener("loadstart", function (event) {
                                    if (event.url.indexOf("http://localhost/callback") === 0) {
                                        requestToken = event.url.split("code=")[1];
                                        $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
                                        $http({ method: "post", url: "https://connect.stripe.com/oauth/token", data: "client_id=" + clientId + "&client_secret=" + clientSecret + "&redirect_uri=" + redirect_uri + "&grant_type=authorization_code" + "&code=" + requestToken }).success(function (data) {
                                            deferred.resolve(data);
                                        }).error(function (data, status) {
                                            deferred.reject("Problem authenticating");
                                        })["finally"](function () {
                     ...
                     * @return   promise
                     */
                    rally: function rally(clientId, clientSecret, appScope, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                                ...
                                browserRef.addEventListener("loadstart", function (event) {
                                    if (event.url.indexOf("http://localhost/callback") === 0) {
                                        requestToken = event.url.split("code=")[1];
                                        $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
                                        $http({ method: "post", url: "https://rally1.rallydev.com/login/oauth2/auth", data: "client_id=" + clientId + "&client_secret=" + clientSecret + "&redirect_uri=" + redirect_uri + "&grant_type=authorization_code" + "&code=" + requestToken }).success(function (data) {
                                            deferred.resolve(data);
                                        }).error(function (data, status) {
                                            deferred.reject("Problem authenticating");
                                        })["finally"](function () {
                     ...
                     * @return   promise
                     */
                    familySearch: function familySearch(clientId, state, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if (cordovaMetadata.hasOwnProperty("cordova-plugin-inappbrowser") === true) {
                                ...
                                browserRef.addEventListener("loadstart", function (event) {
                                    if (event.url.indexOf(redirect_uri) === 0) {
                                        var requestToken = event.url.split("code=")[1];
                                        $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
                                        $http({ method: "post", url: "https://ident.familysearch.org/cis-web/oauth2/v3/token", data: "client_id=" + clientId + "&redirect_uri=" + redirect_uri + "&grant_type=authorization_code&code=" + requestToken }).success(function (data) {
                                            deferred.resolve(data);
                                        }).error(function (data, status) {
                                            deferred.reject("Problem authenticating");
                                        })["finally"](function () {
                     ...
                     * @return   promise
                     */
                    envato: function envato(clientId, options) {
                        var deferred = $q.defer();
                        if (window.cordova) {
                            var cordovaMetadata = cordova.require("cordova/plugin_list").metadata;
                            if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
...
System.register('ng-cordova/push', [], function (_export) {
...
System.register('ng-cordova/sqlite', [], function (_export) {
  ...
  return {
    ...
    execute: function () {
      angular.module('ngCordova.plugins.sqlite', []).factory('$cordovaSQLite', ['$q', '$window', function ($q, $window) {
        ...
        return {
          openDB: function openDB(dbName, background) {
          ...
          execute: function execute(db, query, binding) {
            var q = $q.defer();
          ...
          insertCollection: function insertCollection(db, query, bindings) {
            var q = $q.defer();
          ...
          nestedExecute: function nestedExecute(db, query1, query2, binding1, binding2) {
            var q = $q.defer();
          ...
          deleteDB: function deleteDB(dbName) {
            var q = $q.defer();
